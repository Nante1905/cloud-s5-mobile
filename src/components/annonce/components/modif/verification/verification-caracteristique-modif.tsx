...
import "./verification-annonce-modif.css";
import { Annonce, Marque, StepCreationAnnonceProps, VerificationAnnonceProps } from "../../../../../shared/types/creation-annonce-types";

const VerificationCaracteristiqueModif:React.FC<VerificationAnnonceProps> = (props : VerificationAnnonceProps ) => {
    return (
...
export default VerificationCaracteristiqueModif;