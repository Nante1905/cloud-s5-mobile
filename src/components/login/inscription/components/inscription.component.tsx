...
const InscriptionComponent : React.FC<InscriptionProps> = (props: InscriptionProps) => {
    ...
    const submitForm  = ()=>{
        ...
        if(props.newUser.adresse!='' && props.newUser.password!='' && props.newUser.email!='' && props.newUser.prenom!='' && props.newUser.nom!=''){
              ...
              <div className="ion-padding form-inscription">
                ...
                <div className="form-login">
                    <div className="form-group">
                        ...
                        <input className={state.nomClasse} type="text" onChange={handleNomChange} value={props.newUser.nom}/>
                    </div>
                    <div className="form-group">
                        <label>
                            Prénom
                        </label>
                        <input className={state.prenomClasse} onChange={handlePrenomChange} type="text" value={props.newUser.prenom}/>
                    </div>
                    <div className="form-group">
                        <label>
                            Email
                        </label>
                        <input className={state.emailClasse} onChange={handleEmailChange} type="email" value={props.newUser.email}/>
                    </div>
                    <div className="form-group">
                        <label>
                            Mot de passe
                        </label>
                        <input className={state.passwordClasse} onChange={handlePasswordChange} type="password" value={props.newUser.password}/>
                    </div>
                    <div className="form-group">
                        <label>
                            Addresse
                        </label>
                        <input className={state.adresseClasse} onChange={handleAdresseChange} type="text" value={props.newUser.adresse}/>
                    </div>
